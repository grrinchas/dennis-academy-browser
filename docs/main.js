...
var _user$project$Model$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {topics: a, brand: b, location: c, window: d, responsive: e, userForm: f, signUp: g, token: h, user: i};
	});
...
var _user$project$Messages$OnTokenLoad = function (a) {
	return {ctor: 'OnTokenLoad', _0: a};
};
...
var _user$project$Persistence$get = _elm_lang$core$Native_Platform.incomingPort(
	'get',
									...
									return A2(
										...
										function (tokenType) {
											return A2(
												...
												function (expiresIn) {
													return _elm_lang$core$Json_Decode$succeed(
														{accessToken: accessToken, idToken: idToken, tokenType: tokenType, expiresIn: expiresIn});
												},
...
var _user$project$Views_Pages$mapAuthorised = F3(
	function (model, view, response) {
		var _p8 = response;
		switch (_p8.ctor) {
			case 'NotAsked':
			...
			case 'Success':
				return view(_p8._0);
			default:
				return _user$project$Views_Pages$error(_p8._0);
		}
	});
var _user$project$Views_Pages$userHome = function (model) {
	...
	return A3(_user$project$Views_Pages$mapAuthorised, model, view, model.user);
};
	...
	switch (_p9.ctor) {
		...
		default:
			...
			if (_p10.ctor === 'BadStatus') {
				return _elm_lang$core$Native_Utils.eq(_p10._0.status.code, 403) ? _user$project$Views_Layout$onlyMain(
					A2(
						_user$project$Views_Registration$loginView,
						model.userForm,
						_elm_lang$core$Maybe$Just('Wrong email or password.'))) : _user$project$Views_Pages$error(_p11);
			} else {
				return _user$project$Views_Pages$error(_p11);
			}
	}
};
	...
	function (view, response) {
		...
		switch (_p12.ctor) {
			...
			case 'Success':
				return view(_p12._0);
			default:
				return _user$project$Views_Pages$error(_p12._0);
		}
	});
...
var _user$project$Views_Pages$topics = function (model) {
	var view = function (_p13) {
		var _p14 = _p13;
		return A2(
			_user$project$Views_Layout$headerMain,
			_user$project$Views_NavBar$view(_p14._0),
			_user$project$Views_Topics$view(_p14._1));
	};
	return A2(
				...
				A2(
					...
					function (topic) {
						return A2(
							...
							_user$project$Views_NavBar$view(_p16._0),
							_user$project$Views_Topic$view(topic));
					},
					A2(_user$project$Views_Pages$findTopic, id, _p16._1)));
		};
		return A2(
			_user$project$Views_Pages$map,
			view,
				...
				A3(
					...
					F2(
						function (top, ques) {
							return A2(
								_user$project$Views_Layout$noContainer,
								_user$project$Views_NavBar$view(_p18._0),
								A2(_user$project$Views_Question$view, top, ques));
						}),
					A2(_user$project$Views_Pages$findTopic, topicId, _p19),
					A2(
...
var _user$project$Main$redirect = F2(
	function (location, model) {
		var route = _user$project$Routes$parseLocation(location);
		return ((_elm_lang$core$Native_Utils.eq(route, _user$project$Routes$SignUpRoute) || _elm_lang$core$Native_Utils.eq(route, _user$project$Routes$LoginRoute)) && _krisajenkins$remotedata$RemoteData$isSuccess(model.user)) ? {
			ctor: '_Tuple2',
			_0: model,
...
var _user$project$Main$onFetchUserInfo = F2(
	function (user, model) {
		return _krisajenkins$remotedata$RemoteData$isSuccess(user) ? {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{user: user}),
	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'OnLocationChange':
				return A2(_user$project$Main$redirect, _p2._0, model);
			case 'OnUserSignUp':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'OnFetchUserInfo':
				return A2(_user$project$Main$onFetchUserInfo, _p2._0, model);
			case 'OnWindowChange':
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							token: A2(
								_elm_lang$core$Maybe$withDefault,
								model.token,
								A2(_elm_lang$core$Maybe$map, _krisajenkins$remotedata$RemoteData$succeed, _p5))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Main$page = function (model) {
	var _p6 = _user$project$Routes$parseLocation(model.location);
	switch (_p6.ctor) {
		case 'HomeRoute':
		...
		case 'TopicRoute':
			return A2(_user$project$Views_Pages$topic, model, _p6._0);
		case 'QuestionRoute':
			return A3(_user$project$Views_Pages$question, model, _p6._0, _p6._1);
		case 'SignUpRoute':
...
var _user$project$Main$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Model$initialModel(location),
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Persistence$get(_user$project$Messages$OnTokenLoad),
			_1: {
				ctor: '::',
